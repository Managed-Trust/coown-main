      ...
      <Container maxWidth="lg">
        <Grid container  spacing={2} >
          <Grid item xs={6}>
            ...
            <Link to="/ico"><Button variant="outlined" sx={{ mt: 1, fontSize:'16px', fontWeight:'600' }}>
              Learn more
            </Button></Link>
          </Grid>
          <Grid item   xs={6} >
            <Grid container spacing={1} alignItems="center">
              <Grid item sx={{ marginRight: '20px' }}>
                ...
                <Typography variant="body2" fontSize="16px" fontWeight="400" align="center" color="#5A6A85">
                  Days
                </Typography>
              </Grid>
              <Grid item sx={{ marginRight: '20px' }}>
