        ...
        <Box sx={{ width: '100%' }} mt={4}>
            <Grid container spacing={3}>
                <Grid item xs={12} sm={6} md={3}>
                    <Card title="Operator Groups" value="36" percentage="7.11" />
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                    <Card title="Total Operators" value="42" percentage="7.11" />
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                    <Card title="Total balance" value="$300 000" percentage="7.11" />
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                    <Card title="Total revenue" value="$300 000" percentage="7.11" />
                </Grid>
            </Grid>
        </Box>
    );
